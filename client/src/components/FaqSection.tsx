const FAQs = [
  ["What does Page & Slide do?", "Page & Slide provides presentation design, assignment support, project-report formatting, notes and resume assistance for college students."],
  ...
  ["How does payment work?", "The cart prepares an order request; Page & Slide confirms scope, availability and the next payment step through the selected contact channel before work begins."],
  ["Can students from any college use Page & Slide?", "Yes. Page & Slide is a general student-support service and does not claim affiliation with a particular college or university."],
  ["Does Page & Slide guarantee marks?", "No. Page & Slide does not guarantee grades or academic outcomes. Students remain responsible for accuracy, authorship and their institution's rules."],
  ["How do cancellations and refunds work?", "The outcome depends on whether work has started, whether delivery materially failed, whether a paid priority deadline was missed because of Page & Slide, and whether the request changes the agreed scope. See Refunds & Cancellations for the full route."],
] as const;
