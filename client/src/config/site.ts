...
const ROUTE_DEFINITIONS: readonly PublicRoute[] = [
  ...
  { path: "/privacy", title: "Privacy Policy | Page & Slide", description: "How Page & Slide handles cart data, order details, WhatsApp and Telegram sharing, third-party services and customer privacy requests.", h1: "Privacy Policy", summary: "A clear explanation of what stays in your browser, what is shared only when you choose a channel, and how to make a privacy request.", indexable: true },
  ...
  { path: "/contact", title: "Contact Page & Slide | WhatsApp and Telegram Ordering", description: "Contact Page & Slide through the configured WhatsApp or Telegram channels, with a clear support and grievance process.", h1: "Contact Page & Slide", summary: "Send an order brief through WhatsApp or Telegram, or use the support process when you need help with an existing order.", indexable: true },
