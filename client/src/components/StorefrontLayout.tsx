...
export function StorefrontLayout({ children }: PropsWithChildren) {
  ...
  return <div className="site-shell" id="top">
    ...
    {children}
    <footer className="site-footer"><div className="footer-top"><div><a href="/" className="wordmark wordmark--footer" aria-label="Page & Slide home"><img src="/logo-mark.svg" alt="" aria-hidden="true" /><span>PAGE <span className="wordmark-rule" /> SLIDE</span></a><p>Student presentation and document support.</p></div><nav aria-label="Footer navigation"><a href="/#services">Services</a><a href="/#how-it-works">How it works</a><a href="/#faq">FAQ</a><a href="/contact">Contact</a><a href="/accessibility">Accessibility</a><span className="footer-group-label">Policies</span><a href="/terms">Terms</a><a href="/privacy">Privacy</a><a href="/refunds">Refunds</a><a href="/delivery-revisions">Delivery</a><a href="/academic-integrity">Academic integrity</a><FooterContactActions /></nav></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Page & Slide. All rights reserved.</span><span>For college students generally. No college or university affiliation is claimed.</span></div></footer>
